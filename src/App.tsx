...
function App() {
  ...
  return (
    <main className="App w-[100vw] h-[100vh] pb-14 bg-aztec">
      ...
      {/* SECTION TWO */}
      <section className="px-6 sm:px12 pt-12 lg:pt-8 m-auto lg:w-[900px] xl:w-[1200px]">
        ...
        <div className="mt-5 lg:mt-14">
          ...
          <ul className="text-gold-sand flex flex-col gap-4 xl:gap-[35px] 3xl:gap-[46px] mt-2 2xl:mt-4">
            <li className="bg-firefly text-center text-[22px] md:text-[30px] xl:text-[50px] 4xl:text-[80px] rounded lg:rounded-[15px] 4xl:rounded-[25px] py-5 md:py-7 lg:py-10 xl:py-14 4xl:py-[66px] font-bold w-[85%]">
              Up to 30,000 TEDY
            </li>
            <li className="bg-firefly text-center text-[22px] md:text-[30px] xl:text-[50px] 4xl:text-[80px] lg:rounded-[15px] rounded 4xl:rounded-[25px] xl:py-14 py-5 lg:py-10 md:py-7 4xl:py-[66px] font-bold w-[85%] self-end">
              +3% FISO Rewards <span className="text-[8px] md:text-[12px] 3xl:text-[16px]">+up to 20%</span>
            </li>
            <li className="bg-firefly text-center text-[22px] md:text-[30px] xl:text-[50px] 4xl:text-[80px] lg:rounded-[15px] rounded 4xl:rounded-[25px] xl:py-14 py-5 lg:py-10 md:py-7 4xl:py-[66px] font-bold w-[85%]">
